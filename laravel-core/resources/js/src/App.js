        ...
        <ThemeContextProvider>
          <LoadingContextProvider>
            <Router>
              ...
              <Route path='/user-confirm/:phoneNumber' component={UserConfirm} />
              <RegisterContextProvider>
                <Route path='/register' component={RegisterScreen} exact />
                <Route path='/register/form-1' component={RegisterScreenForm1} />
                <Route path='/register/form-2' component={RegisterScreenForm2} />
